...
function video_shortcode($atts, $content=null){
	...
	<!-- Begin Video.js -->
	<video id="{$id}" class="video-js vjs-default-skin{$class} vjs-big-play-button" width="{$width}" onclick="togglePause()" height="{$height}"{$poster_attribute}{$controls_attribute}{$preload_attribute}{$autoplay_attribute}{$loop_attribute}{$muted_attribute} data-setup='{$jsonDataSetup}'>
		{$mp4_source}
		{$webm_source}
		{$ogg_source}{$track}
	</video>
